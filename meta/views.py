...
class Meta(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.title = kwargs.get('title')  or settings.DEFAULTS.get("title")
        self.description = kwargs.get('description')  or settings.DEFAULTS.get("description")
        self.extra_props = kwargs.get('extra_props')
        self.extra_custom_props = kwargs.get('extra_custom_props')
        self.keywords = kwargs.get('keywords')
        self.url = kwargs.get('url')  or settings.DEFAULTS.get("url")
        self.image = kwargs.get('image')  or settings.DEFAULTS.get("image")
